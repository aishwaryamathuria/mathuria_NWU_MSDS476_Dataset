...
for i in [5, 10, 15]:
    ...
    balking_queue_length = i  # longest queue length that customers will tolerate
    ...
    event_log_df = pd.DataFrame({
                                'barista_count_setting': str(baristas),
    ...
    output_data.append({
        ...
        "total_balked": str(len(event_log_df['activity'][event_log_df['activity']=='balk'])),
    })
